...
#
# v2 locks the surface to AT MOST 19 user-facing slash commands, with 1 slot
# reserved (so 18 in active use). A user-facing command is either:
...
#
# This gate counts both sources and asserts total <= 19. It reports the count
