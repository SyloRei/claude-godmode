...
#
# v2 locks the surface to AT MOST 18 user-facing slash commands, with 1 slot
# reserved (so 17 in active use). A user-facing command is either:
...
#
# This gate counts both sources and asserts total <= 18. It reports the count
