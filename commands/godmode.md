...
**Cold start** (no `.planning/STATE.md`, or no state recorded): the project has no recorded direction — there is no active mission yet. The next command is `/mission`; after that, `/brief 1`.
